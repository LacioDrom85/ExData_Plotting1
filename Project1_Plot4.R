...
with(Final_EPC, {
  # 1
  plot(Final_EPC$GAP~Final_EPC$Datetime, type="l", ylab="Global Active Power (kilowatts)", xlab="")
  # 2
  ...
  # 3
  plot(Final_EPC$Voltage~Final_EPC$Datetime, type="l", ylab="Voltage", xlab="Datetime")
  # 4
  plot(Final_EPC$GRP~Final_EPC$Datetime, type="l", ylab="Global Reactive Power", xlab="Datetime")
})
dev.off()
